...
ros2 launch andr stack.launch.py

# Custom config
ros2 launch andr stack.launch.py config:=/path/to/my_stack.yaml

# Override log level
ros2 launch andr stack.launch.py log_level:=debug
...
def _get_default_config() -> str:
    return os.path.join(
        get_package_share_directory("andr"), "config", "stack.yaml"
    )
