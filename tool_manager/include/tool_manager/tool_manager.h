...
#include <andr/srv/register_tool.hpp>
#include <andr/srv/deregister_tool.hpp>
#include <andr/srv/list_tools.hpp>
...
public:
  ...
  using RegisterTool   = andr::srv::RegisterTool;
  using DeregisterTool = andr::srv::DeregisterTool;
  using ListTools      = andr::srv::ListTools;
